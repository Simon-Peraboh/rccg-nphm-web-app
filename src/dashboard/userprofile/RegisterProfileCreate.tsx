...
const RegisterProfileCreate: React.FC = () => {
  ...
  useEffect(() => {
    axios.get("https://app.rccgphm.org/api/userProfile/regions").then((res) => {
      setRegions(res.data);
    });

    axios.get("https://app.rccgphm.org/api/userProfile/states").then((res) => {
      setStates(res.data);
    });
  }, []);
  ...
  useEffect(() => {
    if (form.region) {
      axios
        .get(`https://app.rccgphm.org/api/userProfile/provinces/${form.region}`)
  ...
  useEffect(() => {
    if (form.state) {
      axios
        .get(`https://app.rccgphm.org/api/userProfile/lgas/${form.state}`)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await axios.post("https://app.rccgphm.org/api/userProfile/createUser", formData, {
