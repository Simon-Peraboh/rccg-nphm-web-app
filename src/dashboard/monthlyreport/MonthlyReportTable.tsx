...
const MonthlyReportTable: React.FC = () => {
  ...
  const fetchReports = async () => {
    try {
      const response = await axios.get<MonthlyReport[]>("https://app.rccgphm.org/api/monthlyReports/getAllReports");
      ...
      buttons: [
        {
          ...
          onClick: async () => {
            try {
              await axios.delete(`https://app.rccgphm.org/api/monthlyReports/deleteReport/${id}`);
