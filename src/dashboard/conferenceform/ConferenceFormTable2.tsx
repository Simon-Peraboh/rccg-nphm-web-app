...
const ConferenceFormTable2: React.FC = () => {
  ...
  const currentUsers = users.filter(user => {
    const userYear = user.conference_date
      ? new Date(user.conference_date).getFullYear().toString()
      : "";
  ...
  return (
    <div className="overflow-x-auto">
      <div className="flex items-center justify-between p-2 mb-4 rounded-xl">
        <input
          type="text"
          placeholder="Search by region or province (e.g. LP 27, Region 19)"
          value={searchTerm}
...
export default ConferenceFormTable2;
